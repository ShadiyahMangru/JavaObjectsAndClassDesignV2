...
public class DataReaderV5{ 
	...
	public void mainMenu(){
		...
		try{
			...
			if(userChoice == getAvaPositions().size() + 2){
				...
				System.out.println(getAvaPositions().get(userChoice-1) + " Points/Wins Horizontal Bar Graph: " );
				hpList.clear();
				...
				System.out.println("All Current Players Points/Wins Horizontal Bar Graph: ");
				hpList.clear();
				for(int i = 0; i<getAvaPositions().size(); i++){
	...
	public static void main(String[] args) throws Exception{ 
    		DataReaderV5 dr = new DataReaderV5();
    		dr.mainMenu();
      } 
} 