...
public class DataReaderV3{ 
	...
	public void printBarGraph(ArrayList<HockeyPlayer> hpList){
		...
		System.out.println();
		//print x-axis labels
		System.out.print(String.format("%-6s | ", "Year"));	
		for(HockeyPlayer h : hpList){
			System.out.print(String.format("%-3s | ", "#" + h.getJersey()));
		}
		System.out.println();
		System.out.print("________");
		for(HockeyPlayer h : hpList){
		...
		for(Object o : avaYears){
			System.out.print(String.format("%-6s | ", o));
			for(HockeyPlayer h : hpList){
	...
	public void mainMenu(){
		System.out.println("******************************************************************");
		System.out.println("CURRENT ROSTER SENIORITY *BAR GRAPH* WIZARD");
		System.out.println("\n\tMAIN MENU:\n");
		System.out.println("\tSelect a Position to view Seniority Bar Graph");
		int counter = 1;
		...
		try{
			...
			if(userChoice == getAvaPositions().size() + 2){
				...
				System.out.println(getAvaPositions().get(userChoice-1) + " Seniority Bar Graph: " );
				hpList.clear();
				...
				System.out.println("All Current Players Seniority Bar Graph: ");
				hpList.clear();
				for(int i = 0; i<getAvaPositions().size(); i++){
	...
	public static void main(String[] args) throws Exception{ 
    		DataReaderV3 dr = new DataReaderV3();
    		dr.mainMenu();
      } 
} 